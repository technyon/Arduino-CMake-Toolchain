...
function (SetupBoardToolchain boards_namespace board_id generate_dir)
	...
	# remove everything after the initial numbers and dots (to clean up version strings like 1.8.19+dfsg1-2)
	string(REGEX REPLACE "^([0-9.]+).*" "\\1" _version_comp "${_version}")
	# replace dots with semicolons to make it a list
	string(REPLACE "." ";" _version_comp "${_version_comp}")
	set(_version "")
	set(_b_first TRUE)
